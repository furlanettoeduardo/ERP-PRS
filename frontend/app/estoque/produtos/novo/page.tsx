  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-gray-600 mt-2">Cadastre um novo produto no estoque</p>
      </div>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="currentStock" className="block text-gray-700 text-sm font-medium mb-2">
                Estoque Inicial <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
                id="currentStock"
