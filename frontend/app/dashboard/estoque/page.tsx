  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 mt-2">Controle e monitore seu inventário</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-[#111827] border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Movimentações (30d)</p>
              <p className="text-3xl font-bold text-white mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-[#111827] border-gray-700 p-6">
          ...
          <div className="space-y-3">
            <a
              href="/dashboard/estoque/produtos/novo"
              className="block p-4 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors"
            >
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-white font-medium">Cadastrar Produto</p>
                  <p className="text-gray-400 text-sm">Adicionar novo item ao estoque</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-white font-medium">Ver Produtos</p>
                  <p className="text-gray-400 text-sm">Lista completa do inventário</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-white font-medium">Movimentações</p>
                  <p className="text-gray-400 text-sm">Histórico de entradas e saídas</p>
                </div>
              </div>
            </a>
          </div>
        ...
        <Card className="bg-[#111827] border-gray-700 p-6">
          ...
          {stats && stats.lowStockProducts > 0 ? (
            ...
            <div className="text-center py-8 text-gray-400">
              ...
              <p className="text-sm text-gray-500 mt-1">Seu estoque está em níveis adequados</p>
            </div>
          )}
        </Card>
      </div>
